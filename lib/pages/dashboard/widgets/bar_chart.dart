...
class SimpleBarChart extends StatelessWidget {
  ...
  final bool? animate;
  SimpleBarChart(this.seriesList, {super.key, this.animate});
  ...
  static List<charts.Series<OrdinalSales, String>> _createSampleData() {
    ...
    con.fetchDataAndCountOrders();

    print('object ' + con.state.orderCounts.value.toString());
    final data = [
      OrdinalSales('Today', con.state.orderCounts.value),
